...
class MessageGeneral PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_message_5fgeneral_2eproto);
    return ::descriptor_table_message_5fgeneral_2eproto.file_level_metadata[kIndexInFileMessages];
  }
